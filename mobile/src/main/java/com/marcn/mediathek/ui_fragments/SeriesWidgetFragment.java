...
public class SeriesWidgetFragment extends Fragment {
...
//    private static final String ARG_WIDGET_URL = "widget-url";
    ...
    private SeriesWidgetAdapter mVideoAdapter;
    ...
    public static SeriesWidgetFragment newInstance(String channelTitle, String assetId, String widgetTitle) {
        SeriesWidgetFragment fragment = new SeriesWidgetFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mVideoAdapter = new SeriesWidgetAdapter(new ArrayList<Series>(), mListener);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                final ArrayList<Series> series
                        = mStation.fetchWidgetSeries(mHeaderTitle, mAssetId, VIDEO_ITEM_COUNT);
                if (getActivity() == null) return;
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if (series != null) {
                            mVideoAdapter.updateValues(series);
                            animateInFromBottom();
                        } else {
                            removeFragment();
                        }
